                                ...
                                <form action="/admin/update/{{ $edit->id }}" method="POST">
                                    ...
                                    <div class="user-details">
                                        ...
                                        <div class="input-box">
                                            ...
                                            <input type="text" name="email" value="{{ $edit->email }}" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="details">Mật khẩu</span>
                                            <input type="password" name="password" value="{{ $edit->password }}" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="details">Cấp độ</span>
                                            <input type="number" name="level" value="{{ $edit->level }}" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="details">Vai trò</span>
                                            <input type="text" name="role" value="{{ $edit->role }}" required>
                                        </div>
                                    </div>
                                    <div class="button">
