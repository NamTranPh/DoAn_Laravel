...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/css/admin/admin_user.css') }}">
        ...
        <main>
            <div class="page-header">
                <div>
                    ...
                    <button class="btn-add"><a href="{{ route('/vadduser') }}">Thêm tài khoản mới</a></button>
                </div>
            </div>
                ...
                <div class="jobs">
                    <div class="table-responsive">
                        <table id="myTable" class="table-css table-history-order">
                            <thead>
                                <tr>
                                    <th class="image-prod">Mã</th>
                                    <th class="name-prod">Tên</th>
                                    <th class="cate-prod">Email</th>
                                    <th class="des-prod">Cấp độ</th>
                                    <th class="status-prod">Vai trò</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="/admin/delete/{{ $row->id }}" method="POST" onsubmit="return ConfirmDelete( this )">
                                            @method('DELETE')
                                            @csrf
