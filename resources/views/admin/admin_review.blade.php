...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/css/admin/admin_feedback.css') }}">
                        ...
                        <table id="myTable" class="table-css table-history-order">
                            <thead>
                                <tr>
                                    ...
                                    <th class="img-prod">Ảnh sản phẩm</th>
                                    <th class="name-prod">Tên</th>
                                    <th class="status-prod">Nhận xét</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $rv->review_id }}</td>
                                    <td><img src="{{ url($rv->img1) }}" alt="" width="100px"></td>
                                    <td>{{ $rv->name }}</td>
                                    <td>{{ $rv->description }}</td>
                                    <td>
                                        <form action="/admin/review/delete/{{ $rv->review_id }}" method="POST" onsubmit="return ConfirmDelete( this )">
                                            @method('DELETE')
                                            @csrf
